...
| `css/foundry.f7c36a08.css` | hand-authored (this repo) | — (not vendored; authored in-tree) | 2026-09-14 | `f7c36a0871d8ab594b6b8767d957b4fbb3eb977b81226feda2b1ed80fb87a3eb` |
...
- `foundry.f7c36a08.css` is hand-authored and served as-authored (gzip via the
  `compression-gzip` tower-http feature handles the wire size); no CSS minifier
  is introduced (DB6). **The `.f7c36a08.` segment is the content hash** (first 8
