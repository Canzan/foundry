...
| `css/foundry.438142d2.css` | hand-authored (this repo) | — (not vendored; authored in-tree) | 2026-09-26 | `438142d24246678eca9a95a1aaeba8b78c52a0b4b9ec1d1c4f9af9a0586d331d` |
...
- `foundry.438142d2.css` is hand-authored and served as-authored (gzip via the
  `compression-gzip` tower-http feature handles the wire size); no CSS minifier
  is introduced (DB6). **The `.438142d2.` segment is the content hash** (first 8
