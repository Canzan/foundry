...
mod static_cache_policy_tests {
    ...
    fn app_js_revalidates_while_hashed_css_and_vendored_libs_stay_immutable() {
        ...
        assert!(
            static_cache_control_value("/static/css/foundry.fe4eb31f.css").contains("immutable")
        );
    ...
    fn an_error_response_is_never_cached_however_immutable_its_path_looks() {
        ...
        for path in [
            "/static/css/foundry.fe4eb31f.css",
        ...
        assert!(
            static_cache_control_value_for(StatusCode::OK, "/static/css/foundry.fe4eb31f.css")
                .contains("immutable")
        );
        assert_eq!(
