...
# (migration 0005 per data-access.md).
#
...
# NFR-SEC-04 (CSRF on multipart POST — multipart is browser-form-origin
#   per the CSRF design; the cap-enforced multipart POST shares the
#   double-submit cookie path),
# NFR-SEC-06 (non-member 403),
